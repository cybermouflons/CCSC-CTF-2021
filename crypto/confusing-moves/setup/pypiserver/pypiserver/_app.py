...
## Custom edit for the challenge. Always return the package with this name!
GLOBAL_PACKAGE_NAME = "pgnparser"
...
def rename_and_pack_wheel(package_name: str):
    ...
    pack(f"/data/packages/{GLOBAL_PACKAGE_NAME}-1.0-py3-none-any/", f"/data/packages/", "1")
...
@auth("list")
def simple(project):
    ## This is a custom edit for the challenge to always return the same package.
    rename_and_pack_wheel(project)
